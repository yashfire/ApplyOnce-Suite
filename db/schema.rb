...
ActiveRecord::Schema.define(version: 20200319122714) do
  ...
  create_table "applicant_addresses", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "applicant_experiences", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "Job_Name"
  ...
  create_table "applicant_person_qualification_field_of_studies", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["applicant_qual_status_id", "applicant_university_id", "applicant_nqf_qualification_id"], name: "my_index", unique: true, using: :btree
  end

  create_table "applicant_personal_details", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "Surname"
    t.string   "First_Name"
  ...
  create_table "applicant_references", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "Contact_Number"
